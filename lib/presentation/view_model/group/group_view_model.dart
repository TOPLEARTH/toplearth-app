...
class GroupViewModel extends GetxController {
  ...
  MonthlyGroupState? get currentMonthData {
    ...
    // Null 안전성 추가
    final monthlyData = teamInfoState.monthlyData;
    if (monthlyData == null || !monthlyData.containsKey(currentMonth)) {
      debugPrint('currentMonthData: 데이터 없음');
      return null;
    }
  ...
  void onInit() {
    ...
    ever(_rootViewModel.isBootstrapLoaded, (isLoaded) {
      if (isLoaded) {
        ...
        print('debug _teamInfoState: ${_teamInfoState.value}');
