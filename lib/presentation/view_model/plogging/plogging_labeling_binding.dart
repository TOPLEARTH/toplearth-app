...
import 'package:toplearth/presentation/view_model/plogging/plogging_labeling_view_model.dart';
...
class PloggingBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<PloggingLabelingViewModel>(() => PloggingLabelingViewModel());
  }
}
