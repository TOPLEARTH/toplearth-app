...
import 'package:toplearth/data/provider/home/home_provider_impl.dart';
...
import 'package:toplearth/data/repository/home_repository_impl.dart';
...
class AppDependency extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<HomeRemoteProvider>(() => HomeRemoteProviderImpl());
